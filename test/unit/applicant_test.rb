...
class ApplicantTest < ActiveSupport::TestCase
  ...
  test "responds to form field values" do
    ...
    assert_equal "", @one.field("FirstName")
    assert_equal "", @one.field("LastName")
    ...
    assert_equal "", @one.field("SSN")
    assert_equal "", @one.field("DOB")
    assert_equal "", @one.field("GenderInitial")
    assert_equal "", @one.field("A#")
    ...
    assert_equal "", @one.field("Accomodations")
    assert_equal "", @one.field("Accomodations2")
