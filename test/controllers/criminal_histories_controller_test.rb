...
class CriminalHistoriesControllerTest < ActionController::TestCase
  ...
  def test_update
    put :update, applicant_id: applicants(:one), id: criminal_history, criminal_history: { crime_type_id: @criminal_history.crime_type_id, description: @criminal_history.description, person_id: @criminal_history.person_id, year: @criminal_history.year }
